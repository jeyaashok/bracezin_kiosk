...
import { Setting, SettingModel, SettingMapModel } from 'src/@bracezin/_dbShare/setting/setting';
...
export class SettingService extends BaseService implements Resolve<any> {
