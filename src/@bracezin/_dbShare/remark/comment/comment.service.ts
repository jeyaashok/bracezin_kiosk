...
import { Comment, CommentModel, CommentMapModel } from 'src/@bracezin/_dbShare/remark/comment';
...
export class CommentService extends BaseService implements Resolve<any> {
