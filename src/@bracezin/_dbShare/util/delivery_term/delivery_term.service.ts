...
import { DeliveryTerm, DeliveryTermModel, DeliveryTermMapModel } from 'src/@bracezin/_dbShare/util/delivery_term';
...
export class DeliveryTermService extends BaseService implements Resolve<any> {
