...
import { Section, SectionModel, SectionMapModel } from 'src/@bracezin/_dbShare/product/section';
...
export class SectionService extends BaseService implements Resolve<any> {
