...
import { Pclass, PclassModel, PclassMapModel } from 'src/@bracezin/_dbShare/product/pclass';
...
export class PclassService extends BaseService implements Resolve<any> {
