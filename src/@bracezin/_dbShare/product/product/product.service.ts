...
import { Product, ProductModel, ProductMapModel } from 'src/@bracezin/_dbShare/product/product';
...
export class ProductService extends BaseService implements Resolve<any> {
