...
import { ExpenseCategory, ExpenseCategoryModel, ExpenseCategoryMapModel } from 'src/@bracezin/_dbShare/expense/expense_category';
...
export class ExpenseCategoryService extends BaseService implements Resolve<any> {
