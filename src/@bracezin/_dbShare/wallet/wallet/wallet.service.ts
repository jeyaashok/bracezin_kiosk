...
import { Wallet, WalletModel, WalletMapModel } from 'src/@bracezin/_dbShare/wallet/wallet';
...
export class WalletService extends BaseService implements Resolve<any> {
