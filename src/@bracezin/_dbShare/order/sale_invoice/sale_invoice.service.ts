...
import { SaleInvoice, SaleInvoiceModel, SaleInvoiceMapModel } from 'src/@bracezin/_dbShare/order/sale_invoice';
...
export class SaleInvoiceService extends BaseService implements Resolve<any> {
