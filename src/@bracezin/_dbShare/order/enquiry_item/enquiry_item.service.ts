...
import { EnquiryItem, EnquiryItemModel, EnquiryItemMapModel } from 'src/@bracezin/_dbShare/order/enquiry_item';
...
export class EnquiryItemService extends BaseService implements Resolve<any> {
