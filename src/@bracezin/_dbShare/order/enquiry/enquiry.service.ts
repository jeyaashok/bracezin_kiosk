...
import { Enquiry, EnquiryModel, EnquiryMapModel } from 'src/@bracezin/_dbShare/order/enquiry';
...
export class EnquiryService extends BaseService implements Resolve<any> {
