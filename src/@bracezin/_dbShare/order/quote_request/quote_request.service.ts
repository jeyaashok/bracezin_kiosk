...
import { QuoteRequest, QuoteRequestModel, QuoteRequestMapModel } from 'src/@bracezin/_dbShare/order/quote_request';
...
export class QuoteRequestService extends BaseService implements Resolve<any> {
